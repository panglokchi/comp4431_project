                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
                    ...
                    for(var i = 0; i < audioSequence.data.length; ++i) {
						...
						if(i < attackDuration) {
							audioSequence.data[i] *= lerp(0.0, 1.0, i/attackDuration);
							...
							audioSequence.data[i] *= lerp(sustainLevel, 0.0, (i - (audioSequence.data.length - releaseDuration))/releaseDuration)
						}
                    }
                ...
                **/
                ...
                for(var c = 0; c < channels.length; ++c) {
					...
					for(var i = 0; i < audioSequence.data.length; ++i) {
						...
						var multiplier = (Math.sin(2 * Math.PI * tremoloFrequency * currentTime - (1/2 * Math.PI)) + 1) / 2;
